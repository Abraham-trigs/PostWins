 ...
 */
export type RoutingStatus = "UNASSIGNED" | "ROUTING" | "MATCHED" | "FALLBACK" | "BLOCKED";
/**
 ...
 */
export type OwnershipStatus = "UNOWNED" | "ACCEPTED" | "ACTIVE" | "COMPLETED" | "REJECTED";
/**
 * Core PostWin record.
 */
...
export interface AuditRecord {
    timestamp: number;
    postWinId: string;
    action: "INTAKE" | "ROUTED" | "ACCEPTED" | "VERIFIED" | "FLAGGED" | "EXECUTED";
    actorId: string;
 ...
 */
export declare const KHALISTAR_ID = "KHALISTAR";
